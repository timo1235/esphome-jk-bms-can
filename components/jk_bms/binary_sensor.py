...
# Ported to ESPHome 2026.x: binary_sensor.BINARY_SENSOR_SCHEMA was removed in favour
# of the binary_sensor.binary_sensor_schema() factory (handles id + icon defaults).
