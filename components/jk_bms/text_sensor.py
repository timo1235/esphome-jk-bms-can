...
# Ported to ESPHome 2026.x: text_sensor.TEXT_SENSOR_SCHEMA removed in favour of the
# text_sensor.text_sensor_schema() factory. Entries that previously used ICON_EMPTY
# now simply omit the icon; ICON_TIMELAPSE inlined as a literal.
